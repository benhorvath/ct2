...
In probit regression, the [cumulative standard normal distribution](https://www.econometrics-with-r.org/11-2-palr.html) function is used to model the regression function when the dependent variable is binary. In logit regression, the [cumulative distribution function](https://www.econometrics-with-r.org/11-2-palr.html#logit-regression) is used. Both types of regression are appropriate for modeling binary response variables. 
...
```{r, echo=FALSE, fig.align='center', fig.cap='Basic statistical summary of the data set'}
summary(train)
```

```{r, echo=FALSE,  fig.align='center', fig.cap='Density plots of the data set'}
...
```{r, echo=FALSE, fig.cap='Univariate relationship between variables'}
...
ggplot(train, aes(x=assoc, fill=switch)) + geom_histogram(stat="count")
```




```{r echo=FALSE, fig.cap='Distributions of switch with the independent variables.'}
...
```{r echo=FALSE, fig.cap='Table: Variable correlations.'}
train_copy <- train
...
```{r, echo=FALSE, fig.cap='Plot: Variable correlations.'}
...
```{r echo=FALSE, fig.cap='Model predictions.'}
