...
To answer this question, we examine a dataset collected in rural Bangladesh (Opar, et al., 2007). It marks whether a household switched wells after learning their routine well had unsafe levels of arsenic.
...
Most the research just cited is primarily concerned with conducting surveys and 'simple' analysis of their results. The most statistically 'sophisticated' work in this literature is Gelman, et al. (2004), and Opar, et al. (2007).
